...
public class DepartmentController {
    ...
    public ResponseEntity<Object> getDepartment(@PathVariable("departmentId") Long departmentId,HttpServletRequest request){

        if (departmentId == null){
            ErrorBody errorBody = new ErrorBody(
                    HttpStatus.BAD_REQUEST,
                    getClass(),
                    "departmentId must not be equals null",
                    request);
        ...
        if (department == null) {
            ErrorBody errorBody = new ErrorBody(
                    ...
                    getClass(),
                    "Not found element with id="+departmentId,
                    request);
